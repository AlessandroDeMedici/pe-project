...
Task::Task(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

Task::Task(const Task& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
{
    this->taskLength = other.taskLength;
}

void Task::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->taskLength);
}

void Task::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->taskLength);
}

double Task::getTaskLength() const
{
    return this->taskLength;
}

void Task::setTaskLength(double taskLength)
{
...
TaskDescriptor::TaskDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(Task)), "omnetpp::cMessage")
{
...
unsigned int TaskDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_taskLength
    };
...
int TaskDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "taskLength") == 0) return baseIndex + 0;
...
std::string TaskDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Task *pp = omnetpp::fromAnyPtr<Task>(object); (void)pp;
    switch (field) {
        case FIELD_taskLength: return double2string(pp->getTaskLength());
        default: return "";
    }
}
...
void TaskDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Task *pp = omnetpp::fromAnyPtr<Task>(object); (void)pp;
    switch (field) {
        case FIELD_taskLength: pp->setTaskLength(string2double(value)); break;
...
omnetpp::cValue TaskDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Task *pp = omnetpp::fromAnyPtr<Task>(object); (void)pp;
    switch (field) {
        case FIELD_taskLength: return pp->getTaskLength();
...
void TaskDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Task *pp = omnetpp::fromAnyPtr<Task>(object); (void)pp;
    switch (field) {
        case FIELD_taskLength: pp->setTaskLength(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Task'", field);
    }
}
